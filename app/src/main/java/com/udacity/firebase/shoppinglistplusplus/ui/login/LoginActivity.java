...
public class LoginActivity extends BaseActivity {
    ...
    //Handle user authentication that was initiated with mFirebaseRef.authWithPassword or mFirebaseRef.authWithOAuthToken
    //when login successfull bring user to main activity cannot go back to login page by clicking back
    //handle responses from server:
    //no connection, invalid email, user does not exist, invalid password
    private class MyAuthResultHandler implements Firebase.AuthResultHandler {
        ...
        //on success auth, call setAuthicatedUser if it was not already called in
        @Override
        ...
        public void onAuthenticationError(FirebaseError firebaseError) {
            ...
            //utility method checks network connection state
            //show no network connection if there is no connection
            //shows firebase specific error message otherwise
