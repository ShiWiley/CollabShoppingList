...
public abstract class BaseActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get mProvider and mEncodedEmail from SharedPerferences
        ...
        //Check if specific class of the activity being instantiated is an instance of an activity accessible only after logging in
        //In that case add an auth state listener . Move code inside auth state listener to sparate helper method
        //Listen moves the user backto the loginActivity screen if they are not logged in
    ...
    //Disconnects the mGoogleApiClient if connected and provider is Google
    private void logout() {
